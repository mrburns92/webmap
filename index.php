          ...
          <ul class="dropdown-menu" style = "min-width: 100%!important">
            <li>
             ...
             <li><a href="#" data-toggle="collapse" data-target=".navbar-collapse.in" id="login-btn"><i
              ...
              <li>   <div class="locationSearchBox">
  ...
  <div class = "row">
    ...
    <div class="col-md-12">
      <div class="input-group">
        <span class="input-group-addon" style = "border-radius: 0px!important; width: fit-content; border: none;">
        ...
        <span class="input-group-addon" style = "white-space: initial; border-radius: 0px!important; width: fit-content; text-align: left !important; border: none; ">
            ...
            <div class="col-md-12 ancientWoodlandKey" style="display:none; padding: 0px 0px 10px 35px; ">
              <svg overflow="hidden" width="30" height="30" style="touch-action: none;">
                ...
                <path fill="#b9522f" fill-opacity="1" stroke="rgb(110, 110, 110)" stroke-opacity="1"
                  stroke-width="1.3333333333333333" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="4"
                  path="M -10,-10 L 10,0 L 10,10 L -10,10 L -10,-10 Z" d="M-10-10L 10 0L 10 10L-10 10L-10-10Z"
                  fill-rule="evenodd" stroke-dasharray="none" dojoGfxStrokeStyle="solid"
